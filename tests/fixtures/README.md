...
**Generated By**:
- MATLAB scripts in `../multisensor-lmb-filters/` repository (external)
...
**Generated By**:
- MATLAB scripts in `benchmarks/matlab/` (when they exist) or `../multisensor-lmb-filters/`
...
**Generated By**:
- MATLAB scripts in `../multisensor-lmb-filters/` or `benchmarks/matlab/`
...
1. **Navigate to MATLAB repository**: `cd ../multisensor-lmb-filters/`
2. **Run generation script**: e.g., `generate_lmb_step_by_step(42, 100)` in MATLAB/Octave
3. **Copy to this directory**: `cp output.json ../multisensor-lmb-filters-rs/tests/fixtures/`
...
- MATLAB generation scripts: `../multisensor-lmb-filters/` (external repository)
