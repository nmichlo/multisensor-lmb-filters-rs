//! Multi-sensor Parallel Update (PU) LMB filter example
//!
//! This example demonstrates the PU-LMB filter for multi-sensor tracking.
//! The PU-LMB filter processes all sensors in parallel and then fuses the results.
//!
