...
print(f"MATLAB Gibbs Sampling (seed=42):")
print(f"  Sensors: {n_sensors}")
print(f"  Objects (tracks): {n_objects}")
print(f"  Total samples generated: 1000")
print(f"  Unique samples: {len(samples)}")
print(f"\nAll {len(samples)} unique samples:")
print(f"(Format: [obj0_s0, obj1_s0, obj2_s0, obj3_s0, obj0_s1, obj1_s1, obj2_s1, obj3_s1])")
print(f"where objX_sY = measurement assigned to object X from sensor Y (0=miss)")
